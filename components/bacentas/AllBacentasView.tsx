                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-start gap-2 mb-2 flex-wrap">
                        <h3 className="font-bold text-lg text-slate-900 transition-colors duration-200 break-words min-w-0 flex-1">
                          {b.name}
                        </h3>
                        {b.frozen && (
                          <span className="text-xs px-2 py-1 rounded-full bg-blue-100 text-blue-700 border border-blue-200 shrink-0" title="Frozen – excluded from counts">
                            Frozen
                          </span>
                        )}
                      </div>
