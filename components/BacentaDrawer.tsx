  ...
  return (
    <>
      ...
      <div className={`fixed top-0 left-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl z-50 transform transition-all duration-300 ease-out ${
        ...
        {/* Header */}
        <div className="glass-card border-b border-gray-200/50 p-4">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 p-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl transition-all duration-200 hover:scale-[1.02] shadow-lg hover:shadow-xl"
          >
...
const BacentaItem: React.FC<BacentaItemProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`group relative p-3 rounded-xl cursor-pointer transition-all duration-200 hover:scale-[1.02] ${
        isActive 
...
const NavigationItem: React.FC<NavigationItemProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative w-full flex items-center justify-between p-3 rounded-xl cursor-pointer transition-all duration-200 hover:scale-[1.02] ${
        isActive
          ? 'bg-blue-50 border-2 border-blue-200 shadow-md'
          : 'bg-gray-50 hover:bg-gray-100 border border-gray-200'
      }`}
